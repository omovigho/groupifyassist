      ...
      <main className="relative z-10 px-6 pt-24 pb-24 flex items-center justify-center text-center">
        <div className="w-full max-w-2xl">
          <div className="glass-morphism rounded-2xl p-10 md:p-12">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white">Registration successful</h1>
            <p className="mt-3 text-gray-300 max-w-xl mx-auto">Your account is ready. You can log in now to start using GroupifyAssist.</p>
